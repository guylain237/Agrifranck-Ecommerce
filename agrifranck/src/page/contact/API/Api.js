...
export const IpAddress = async ({setLoading, setIpData}) =>{
    try{
let res = await axios.get(`http://api.ipstack.com/check?access_key=2758b3a263f8ef1c1bbdf1d1d78dd95e`);
if(res){
    setLoading(false);
    setIpData(res.data.country_name);
        ...
        alert(`erreur de l'adresse ip:${error.message}`);
    }
}


/****** avoir le pays '5HyFv0NRJMB8Mn0W53UJjbInRVUPNVhU', */
